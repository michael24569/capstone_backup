...
<div class="sidebar">
    ...
    <div id="statusAccount" class="center_record">
        <div class="table-responsive">
            <h1 id="header1">Manage Staff Accounts</h1>
            <br>
            ...
            <form method="GET" action="">
                <div class="input-group">
                    ...
                    <button class="refresh-icon" onclick="location.reload();"><!-- nasa baba css-->
            ...
            <table class="styled-table text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td id="status-<?php echo $row['id']; ?>"><?php echo htmlspecialchars($row['accountStatus']); ?></td>
