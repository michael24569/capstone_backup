...
<head>
    ...
    <meta http-equiv="Cache-Control" content="no-store" /> <!-- Prevent caching -->
    <meta http-equiv="Pragma" content="no-cache" /> <!-- Ensure no caching in older browsers -->
    <meta http-equiv="Expires" content="0" /> <!-- Expire page immediately -->
...
.loader .background {
  ...
  -webkit-backdrop-filter: blur(20px);
    z-index: -1; /* Ensure it stays behind the spinner */
}

.spinner {
    border: 10px solid rgba(243, 243, 243, 0.2); /* Subtle, semi-transparent white border */
    border-top: 10px solid rgba(243, 243, 243, 0.6); /* Slightly less transparent white for the top */
    border-radius: 50%;
    width: 100px;
    height: 100px;
    animation: spin 1s linear infinite; /* Keep only the spin animation */
    position: relative; /* Ensure it stays on top of the background */
    box-shadow: 0 0 15px rgba(243, 243, 243, 0.4), 0 0 5px rgba(243, 243, 243, 0.2); /* Softer glow effect */
    background: radial-gradient(circle, rgba(255, 255, 255, 0.05), rgba(0, 0, 0, 0.05)); /* Subtle gradient background */
}
  ...
  <div class="panel" id="imagePanel">
    ...
    <div class="SliderContaier">
      ...
      <div class="input-group">
        ...
        <br>
        <button class='btn btn-search' type="button" id="searchButton"><ion-icon name="search-outline"></ion-icon></button>
    </div>
...
<div data-lotno="480" data-memsts="Columbarium1" data-memlot="Lawn Lots" class="grid-itemC1SB">480</div>
        ...
        <map name="mymap" id="mymap">
          ...
          <div class="RAF" id="idRAF"><h3 style="color: white;">St. Rafael</h3><br>
            ...
            <div class="Saints" id="legendBox" style="top: 670px;">
                        <div class="legends">Legend</div>
                        <div class="legendList">
                        <div class="legendU Available"></div>
                        <span>Available</span>
          ...
          <div class="John" id="John">
            ...
            <div class="stJohn" id="idjohn"><h3 style="color: white;">St. John</h3><br>
                ...
                <div class="Saints" id="legendBox" style="top: 675px;">
                        <div class="legends">Legend</div>
                        <div class="legendList">
                        <div class="legendU Available"></div>
                        <span>Available</span>
    ...
    <div data-lotno="303" data-memsts="St. Dominic" data-memlot="Lawn Lots" class="grid-itemdominic">303</div>
          ...
          <div class="stLuke" id="idluke"><h3 style="color: white;">St. Lukes</h3><br>
            ...
            <div class="medium" id="legendBox" style="top: 470px;">
                        <div class="legends">Legend</div>
                        <div class="legendList">
                        <div class="legendU Available"></div>
                        <span>Available</span>
            ...
            <div class="stIsidore" id="idisidore"><h3 style="color: white;">St. Isidore</h3><br>
                ...
                <div class="Michael" id="Michael">
                  ...
                  <div class="stpm" id="idpm"><h3 style="color: white;">St. Michael and St. Patrick</h3><br>
                    ...
                    <div data-lotno="1" data-memsts="St. pm" data-memlot="Garden Lots" class="grid-itempm">1</div>
                    <div data-lotno="2" data-memsts="St. pm" data-memlot="Garden Lots" class="grid-itempm">2</div>
                    <div data-lotno="3" data-memsts="St. pm" data-memlot="Garden Lots" class="grid-itempm">3</div>
                    <div data-lotno="4" data-memsts="St. pm" data-memlot="Garden Lots" class="grid-itempm">4</div>
                    <div data-lotno="5" data-memsts="St. pm" data-memlot="Garden Lots" class="grid-itempm">5</div>
                    <div data-lotno="6" data-memsts="St. pm" data-memlot="Garden Lots" class="grid-itempm">6</div>
                    <div data-lotno="7" data-memsts="St. pm" data-memlot="Garden Lots" class="grid-itempm">7</div>
                    <div data-lotno="8" data-memsts="St. pm" data-memlot="Garden Lots" class="grid-itempm">8</div>
                    <div data-lotno="9" data-memsts="St. pm" data-memlot="Garden Lots" class="grid-itempm">9</div>
                    <div data-lotno="10" data-memsts="St. pm" data-memlot="Garden Lots" class="grid-itempm">10</div>
                    <div data-lotno="11" data-memsts="St. pm" data-memlot="Garden Lots" class="grid-itempm">11</div>
                    <div data-lotno="12" data-memsts="St. pm" data-memlot="Garden Lots" class="grid-itempm">12</div>
                    </div>
                    </div>
        ...
        .then(records => {
               ...
               'grid-itemjames', 'grid-itemmatthew', 'grid-itemagustine', 'grid-itemdominic', 'grid-itemmark', 'grid-itemluke',
                'grid-itemisidore', 'grid-itemC2blk3A', 'grid-itemC2blk3B', 'grid-itemC2blk4A', 'grid-itemC2blk4B', 'grid-itemblk3AC2',
                 'grid-itemblk3BC2', 'grid-itemblk4AC2', 'grid-itemblk4BC2', 'grid-itemC1S11A', 'grid-itemC1S11B',
                  ...
                  'grid-itemC1BLK4B', 'grid-itemC1blk3A2nd', 'grid-itemC1blk3B2nd', 'grid-itemC1blk4A2nd', 'grid-itemC1blk4B2nd']; // Add other classes here
            const results = {};
            ...
            classes.forEach(cls => {
                ...
                document.querySelectorAll(`.${cls}`).forEach(item => {
                    ...
                    const memLot = item.getAttribute('data-memlot') ? item.getAttribute('data-memlot').trim() : null;

                    console.log(`Checking item: lotNo=${lotNo}, memSts=${memSts}, memLot=${memLot}`);

                    if (lotNo && memSts) {
                        const recordExists = records.some(record => {
                            const match = record.Lot_No === lotNo && record.mem_sts === memSts;
                            console.log(`Comparing with record: Lot_No=${record.Lot_No}, mem_sts=${record.mem_sts}, match=${match}`);
                            return match;
                        });

                        console.log(`Record exists for item: lotNo=${lotNo}, memSts=${memSts} -> ${recordExists}`);

                        if (recordExists) {
                            item.style.backgroundColor = 'red'; // Match found
                            matched++;
                        } else {
...
document.addEventListener('DOMContentLoaded', () => {
    function highlightMatchingRecords() {
        const searchValue = document.querySelector('input[name="search"]').value.trim().toLowerCase();
    ...
    '.Matthew, .Luke, .Dominic, .James, .Colum2, .Colum1, ' +
    ...
    '#C12ndflrblk3A, #C12ndflrblk3B, #C12ndflrblck4, #C12ndflrblk4A, #C12ndflrblk4B').forEach(item => {
        ...
        // If the search input is empty, remove highlights and return
        if (!searchValue) {
            ...
            .then(records => {
                ...
                document.querySelectorAll('[data-lotno]').forEach(item => {
                    ...
                    if (recordExists) {
                        ...
                        item.style.border = '2px solid yellow'; // Highlight matched items with yellow border

                        // Call the new function to highlight the specific side based on class
                        highlightSidesBasedOnClass(item);

                        // Highlight the specific divs with IDs 'Paul' and 'Mark'
                        if (memSts === 'st. paul') {
                            document.getElementById('Paul').style.border = '2px solid yellow';
                        } else if (memSts === 'st. mark') {
                            document.getElementById('Mark').style.border = '2px solid yellow';
                        } else if (memSts === 'apartment1') {
                            document.getElementById('Apart1').style.border = '2px solid yellow';
                        } else if (memSts === 'apartment2') {
                            document.getElementById('Apart2').style.border = '2px solid yellow';
                        } else if (memSts === 'apartment3') {
                            document.getElementById('Apart3').style.border = '2px solid yellow';
                        } else if (memSts === 'columbarium2') {
                            document.getElementById('Colum2').style.border = '2px solid yellow';
                        } else if (memSts === 'columbarium1') {
                            document.getElementById('Colum1').style.border = '2px solid yellow';
                        } else if (memSts === 'st. joseph') {
                            document.getElementById('Joseph').style.border = '2px solid yellow';
                        } else if (memSts === 'st. peter') {
                            document.getElementById('Peter').style.border = '2px solid yellow';
                        } else if (memSts === 'st. rafael') {
                            document.getElementById('Rafael').style.border = '2px solid yellow';
                        } else if (memSts === 'st. jude') {
                            document.getElementById('Jude').style.border = '2px solid yellow';
                        } else if (memSts === 'st. augustin') {
                            document.getElementById('Agustine').style.border = '2px solid yellow';
                        } else if (memSts === 'st. isidore') {
                            document.getElementById('Isidore').style.border = '2px solid yellow';
                        } else if (memSts === 'st. john') {
                            document.getElementById('John').style.border = '2px solid yellow';
                        } else if (memSts === 'st. matthew') {
                            document.getElementById('Matthew').style.border = '2px solid yellow';
                        } else if (memSts === 'st. lukes') {
                            document.getElementById('Luke').style.border = '2px solid yellow';
                        } else if (memSts === 'st. dominic') {
                            document.getElementById('Dominic').style.border = '2px solid yellow';
                        } else if (memSts === 'st. james') {
                            document.getElementById('James').style.border = '2px solid yellow';
                        }
                    }
                });
            })
    ...
    // Function to highlight A1sideA or A1sideB based on the class of the matched element
    function highlightSidesBasedOnClass(matchedElement) {
        // Check if the matched element has the class 'grid-itemA'
        //Apartment 1 side A
        if (matchedElement.classList.contains('grid-itemA')) {
            document.getElementById('A1sideA').style.border = '2px solid yellow';
        }

        // Check if the matched element has the class 'grid-itemB'
        //Apartment 1 side B
        if (matchedElement.classList.contains('grid-itemB')) {
            document.getElementById('A1sideB').style.border = '2px solid yellow';
        }
        //////////////////Apartment 2 side A
        if (matchedElement.classList.contains('grid-itemA2')) {
            document.getElementById('A2sideA').style.border = '2px solid yellow';
        }

        // Check if the matched element has the class 'grid-itemB'
        //Apartment 2 side B
        if (matchedElement.classList.contains('grid-itemB2')) {
            document.getElementById('A2sideB').style.border = '2px solid yellow';
        }
        ///////////////// Apartment 3 side A
        if (matchedElement.classList.contains('grid-itemA3')) {
            document.getElementById('A3sideA').style.border = '2px solid yellow';
        }

        // Check if the matched element has the class 'grid-itemB'
        //Apartment 3 side B
        if (matchedElement.classList.contains('grid-itemB3')) {
            document.getElementById('A3sideB').style.border = '2px solid yellow';
        }
        ///////////////
        ...
        if (matchedElement.classList.contains('grid-itemC2S1A')) {
            document.getElementById('C21stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C21stflrSA').style.border = '2px solid yellow';//block
            document.getElementById('C2S1SA').style.border = '2px solid yellow';//side
        }
     //Columbarium 2 1st floor block 1 side B
        if (matchedElement.classList.contains('grid-itemC2S1B')) {
            document.getElementById('C21stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C21stflrSA').style.border = '2px solid yellow';//block
            document.getElementById('C2S1SB').style.border = '2px solid yellow';//side
        }
            ///columbarium 2 1st floor block 2 side A
        if (matchedElement.classList.contains('grid-itemC2S2A')) {
            document.getElementById('C21stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C21stflrSB').style.border = '2px solid yellow';//block
            document.getElementById('C2S2SA').style.border = '2px solid yellow';//side
        }
        //Columbarium 2 1st floor block 2 side B
        if (matchedElement.classList.contains('grid-itemC2S2B')) {
            document.getElementById('C21stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C21stflrSB').style.border = '2px solid yellow';//block
            document.getElementById('C2S2SB').style.border = '2px solid yellow';//side
        }
        //Columbarium 2 1st floor block 3 side A
        if (matchedElement.classList.contains('grid-itemC2blk3A')) {
            document.getElementById('C21stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C21stflrblck3').style.border = '2px solid yellow';//block
            document.getElementById('C2S2blk3A').style.border = '2px solid yellow';//side
        }
        //Columbarium 2 1st floor block 3 side B
        if (matchedElement.classList.contains('grid-itemC2blk3B')) {
            document.getElementById('C21stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C21stflrblck3').style.border = '2px solid yellow';//block
            document.getElementById('C2S2blk3B').style.border = '2px solid yellow';//side
        }
        //Columbarium 2 1st floor block 4 side A
        if (matchedElement.classList.contains('grid-itemC2blk4A')) {
            document.getElementById('C21stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C21stflrblck4').style.border = '2px solid yellow';//block
            document.getElementById('C2S2blk4A').style.border = '2px solid yellow';//side
        }
        //Columbarium 2 1st floor block 4 side B
        if (matchedElement.classList.contains('grid-itemC2blk4B')) {
            document.getElementById('C21stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C21stflrblck4').style.border = '2px solid yellow';//block
            document.getElementById('C2S2blk4B').style.border = '2px solid yellow';//side
        }
        ...
        if (matchedElement.classList.contains('grid-itemC2S12A')) {
            document.getElementById('C22ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C22ndflrSA').style.border = '2px solid yellow';//block
            document.getElementById('C22SA').style.border = '2px solid yellow';//side
        }
        //Columbarium 2 2nd floor block 1 side B
        if (matchedElement.classList.contains('grid-itemC2S12B')) {
            document.getElementById('C22ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C22ndflrSA').style.border = '2px solid yellow';//block
            document.getElementById('C22SB').style.border = '2px solid yellow';//side
        }
        //Columbarium 2 2nd floor block 2 Side A
        if (matchedElement.classList.contains('grid-itemC2S22A')) {
            document.getElementById('C22ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C22ndflrSB').style.border = '2px solid yellow';//block
            document.getElementById('C22SA2').style.border = '2px solid yellow';//side
        }
        //Columbarium 2 2nd floor block 2 Side B
        if (matchedElement.classList.contains('grid-itemC2S22B')) {
            document.getElementById('C22ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C22ndflrSB').style.border = '2px solid yellow';//block
            document.getElementById('C22SB2').style.border = '2px solid yellow';//side
        }
        //Columbarium 2 2nd floor block 3 side A
        if (matchedElement.classList.contains('grid-itemblk3AC2')) {
            document.getElementById('C22ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C22ndflrblck3').style.border = '2px solid yellow';//block
            document.getElementById('C22blk3A').style.border = '2px solid yellow';//side
        }
        //Columbarium 2 2nd floor block 3 side B
        if (matchedElement.classList.contains('grid-itemblk3BC2')) {
            document.getElementById('C22ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C22ndflrblck3').style.border = '2px solid yellow';//block
            document.getElementById('C22blk3B').style.border = '2px solid yellow';//side
        }
        //Columbarium 2 2nd floor block 4 side A
        if (matchedElement.classList.contains('grid-itemblk4AC2')) {
            document.getElementById('C22ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C22ndflrblck4').style.border = '2px solid yellow';//block
            document.getElementById('C22blk4A').style.border = '2px solid yellow';//side
        }
        //Columbarium 2 2nd floor block 4 side B
        if (matchedElement.classList.contains('grid-itemblk4BC2')) {
            document.getElementById('C22ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C22ndflrblck4').style.border = '2px solid yellow';//block
            document.getElementById('C22blk4B').style.border = '2px solid yellow';//side
        }
        ...
        if (matchedElement.classList.contains('grid-itemC1S11A')) {
            document.getElementById('C11stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C11stflrSA').style.border = '2px solid yellow';//block
            document.getElementById('C11stflrSSA').style.border = '2px solid yellow';//side
        }
        //Columbarium 1 1st floor block 1 side B
        if (matchedElement.classList.contains('grid-itemC1S11B')) {
            document.getElementById('C11stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C11stflrSA').style.border = '2px solid yellow';//block
            document.getElementById('C11stflrSSB').style.border = '2px solid yellow';//side
        }
        //Columbarium 1 1st floor block 2 side A
        if (matchedElement.classList.contains('grid-itemC1S22A')) {
            document.getElementById('C11stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C11stflrSB').style.border = '2px solid yellow';//block
            document.getElementById('C11stflrS2SA').style.border = '2px solid yellow';//side
        }
        //Columbarium 1 1st floor block 2 side B
        if (matchedElement.classList.contains('grid-itemC1S22B')) {
            document.getElementById('C11stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C11stflrSB').style.border = '2px solid yellow';//block
            document.getElementById('C11stflrS2SB').style.border = '2px solid yellow';//side
        }
        //Columbarium 1 1st floor block 3 side A
        if (matchedElement.classList.contains('grid-itemC1BLK3A')) {
            document.getElementById('C11stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C11stflrblk3').style.border = '2px solid yellow';//block
            document.getElementById('C11stflrblk3A').style.border = '2px solid yellow';//side
        }
        //Columbarium 1 1st floor block 3 side B
        if (matchedElement.classList.contains('grid-itemC1BLK3B')) {
            document.getElementById('C11stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C11stflrblk3').style.border = '2px solid yellow';//block
            document.getElementById('C11stflrblk3B').style.border = '2px solid yellow';//side
        }
        //Columbarium 1 1st floor block 4 side A
        if (matchedElement.classList.contains('grid-itemC1BLK4A')) {
            document.getElementById('C11stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C11stflrblk4').style.border = '2px solid yellow';//block
            document.getElementById('C11stflrblk4A').style.border = '2px solid yellow';//side
        }
        //Colubarium 1 1st floor block 4 side B
        if (matchedElement.classList.contains('grid-itemC1BLK4B')) {
            document.getElementById('C11stflr').style.border = '2px solid yellow';//floor
            document.getElementById('C11stflrblk4').style.border = '2px solid yellow';//block
            document.getElementById('C11stflrblk4B').style.border = '2px solid yellow';//side
        }
        ...
        if (matchedElement.classList.contains('grid-itemC1S1A')) {
            document.getElementById('C12ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C12ndflrSA').style.border = '2px solid yellow';//block
            document.getElementById('C12ndflrSSA').style.border = '2px solid yellow';//side
        }
        //Columbarium 1 2nd floor block 1 side B
        if (matchedElement.classList.contains('grid-itemC1S1B')) {
            document.getElementById('C12ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C12ndflrSA').style.border = '2px solid yellow';//block
            document.getElementById('C12ndflrSSB').style.border = '2px solid yellow';//side
        }
        //Columbarium 1 2nd floor block 2 side A
        if (matchedElement.classList.contains('grid-itemC1SA')) {
            document.getElementById('C12ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C12ndflrSB').style.border = '2px solid yellow';//block
            document.getElementById('C12ndS2flrSSA').style.border = '2px solid yellow';//side
        }
        //Columbarium 1  2nd floor block 2 side B
        if (matchedElement.classList.contains('grid-itemC1SB')) {
            document.getElementById('C12ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C12ndflrSB').style.border = '2px solid yellow';//block
            document.getElementById('C12ndS2flrSSB').style.border = '2px solid yellow';//side
        }
        //Columbarium 1 2nd floor block 3 side A
        if (matchedElement.classList.contains('grid-itemC1blk3A2nd')) {
            document.getElementById('C12ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C12ndflrblck3').style.border = '2px solid yellow';//block
            document.getElementById('C12ndflrblk3A').style.border = '2px solid yellow';//side
        }
        //Columbarium 1 2nd floor block 3 side B
        if (matchedElement.classList.contains('grid-itemC1blk3B2nd')) {
            document.getElementById('C12ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C12ndflrblck3').style.border = '2px solid yellow';//block
            document.getElementById('C12ndflrblk3B').style.border = '2px solid yellow';//side
        }
        //Columbarium 1 2nd floor block 4 side A
        if (matchedElement.classList.contains('grid-itemC1blk4A2nd')) {
            document.getElementById('C12ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C12ndflrblck4').style.border = '2px solid yellow';//block
            document.getElementById('C12ndflrblk4A').style.border = '2px solid yellow';//side
        }
        //Columbarium 1 2nd floor block 4 side B
        if (matchedElement.classList.contains('grid-itemC1blk4B2nd')) {
            document.getElementById('C12ndflr').style.border = '2px solid yellow';//floor
            document.getElementById('C12ndflrblck4').style.border = '2px solid yellow';//block
            document.getElementById('C12ndflrblk4B').style.border = '2px solid yellow';//side
        }
    }

    // Attach the search function to the search button click event
    document.querySelector('.btn-search').addEventListener('click', highlightMatchingRecords);
});
//Loading screen
document.addEventListener("DOMContentLoaded", function() {
        ...
        window.addEventListener("load", function() {
            ...
            }, 400);  // Optional small delay to force a repaint (can be adjusted or removed)
        });
    </script>
</body>
</html>
